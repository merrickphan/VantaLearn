...
export const AP_UNITS_BY_COURSE_ID: Record<string, ApUnit[]> = {
  ...
  "physics-c-em": U("physics-c-em", [
    ...
    { title: "Magnetic Fields", summary: "Biot–Savart, Ampère’s law, forces on charges/currents.", hooks: ["Ampère loops", "force on wire", "cyclotron motion"] },
  ...
  chem: U("chem", [
    ...
    { title: "Thermodynamics", summary: "Enthalpy, Hess’s law, calorimetry, entropy and Gibbs.", hooks: ["Hess cycles", "ΔG and spontaneity", "bond enthalpy estimates"] },
    { title: "Equilibrium", summary: "Kc/Kp, Le Châtelier, solubility product.", hooks: ["ICE tables", "Q vs K", "common ion"] },
    { title: "Acids and Bases", summary: "pH, buffers, titration curves, Ka/Kb.", hooks: ["buffer capacity", "half-equivalence", "polyprotic steps"] },
    { title: "Applications of Thermodynamics", summary: "Electrochemistry, ΔG and cells, electrolysis.", hooks: ["cell potential", "Nernst qualitative", "Faraday’s laws intro"] },
  ]),
  ...
  env: U("env", [
    ...
    { title: "Earth Systems and Resources", summary: "Geology, atmosphere, water resources.", hooks: ["soil formation", "aquifers", "El Niño intro"] },
  ...
  "hum-geo": U("hum-geo", [
    ...
    { title: "Agriculture and Rural Land Use", summary: "von Thünen, Green Revolution, subsistence vs commercial.", hooks: ["agricultural hearths", "subsidy effects", "sustainable ag"] },
  ...
  french: U("french", [
    ...
    { title: "Personal and Public Identities", summary: "Values, multiculturalism, language policy.", hooks: ["laïcité context", "identity in Quebec", "code-switching"] },
  ...
  chinese: U("chinese", [
    ...
    { title: "Science and Technology", summary: "Innovation, mobile life, environment.", hooks: ["result complements", "科技 vocabulary", "future plans"] },
    { title: "Contemporary Life", summary: "Transport, shopping, leisure.", hooks: ["directions", "bargaining", "habits with 了"] },
    { title: "Global Challenges", summary: "Development, climate, public health.", hooks: ["把 sentences", "formal register", "policy vocabulary"] },
  ]),
  ...
  japanese: U("japanese", [
    ...
    { title: "Global Challenges", summary: "Aging society, energy, international relations.", hooks: ["cause から/ので", "debate stems", "news vocabulary"] },
  ]),
