...
export const AP_UNITS_BY_COURSE_ID: Record<string, ApUnit[]> = {
 ...
 "physics-c-em": unitsDetailed("physics-c-em", [
  {
   title: "Electrostatics (Charge and Coulomb’s Law)",
   summary:
    "Lesson 1.1 Electric charge: conservation, quantization, sign conventions; Lesson 1.2 Coulomb’s law (F = k q₁q₂ / r²) and vector form; Lesson 1.3 Superposition principle for multiple charges; Lesson 1.4 Discrete charge systems and symmetry shortcuts; Lesson 1.5 Electric force vs gravitational force comparison (structure, scaling).",
   hooks: [
    "Lesson 1.1 electric charge: conservation",
    "Lesson 1.1 electric charge: quantization",
    "Lesson 1.1 electric charge: sign conventions",
    "Lesson 1.2 Coulomb’s law F = k q1 q2 / r^2",
    "Lesson 1.2 Coulomb’s law vector form",
    "Lesson 1.3 superposition principle (multiple charges)",
    "Lesson 1.4 discrete charge systems",
    "Lesson 1.4 symmetry shortcuts (discrete charges)",
    "Lesson 1.5 electric vs gravitational force comparison",
    "Lesson 1.5 inverse-square scaling comparison",
   ],
  },
  {
   title: "Electric Fields",
   summary:
    "Lesson 2.1 Electric field definition (E = F/q); Lesson 2.2 Field of point charges and vector addition; Lesson 2.3 Continuous charge distributions (line, ring, disk — calculus-based setup); Lesson 2.4 Electric field diagrams and field line interpretation; Lesson 2.5 Gauss’s law introduction (qualitative + flux meaning).",
   hooks: [
    "Lesson 2.1 electric field definition E = F/q",
    "Lesson 2.2 field of point charges",
    "Lesson 2.2 vector addition of fields",
    "Lesson 2.3 continuous charge distributions (line) setup",
    "Lesson 2.3 continuous charge distributions (ring) setup",
    "Lesson 2.3 continuous charge distributions (disk) setup",
    "Lesson 2.4 electric field diagrams",
    "Lesson 2.4 field line interpretation",
    "Lesson 2.5 Gauss’s law introduction (qualitative)",
    "Lesson 2.5 electric flux meaning (qualitative)",
   ],
  },
  {
   title: "Gauss’s Law (core C-level unit)",
   summary:
    "Lesson 3.1 Electric flux (ΦE = E·A cosθ); Lesson 3.2 Gauss’s law (∮E·dA = Qenc/ε₀); Lesson 3.3 Symmetry arguments (spherical, cylindrical, planar); Lesson 3.4 Applications: infinite line of charge; infinite plane of charge; conducting sphere; Lesson 3.5 Conductors in electrostatic equilibrium; Lesson 3.6 Charge distribution on conductors.",
   hooks: [
    "Lesson 3.1 electric flux ΦE = E·A cosθ",
    "Lesson 3.2 Gauss’s law ∮E·dA = Qenc/ε0",
    "Lesson 3.3 symmetry arguments: spherical",
    "Lesson 3.3 symmetry arguments: cylindrical",
    "Lesson 3.3 symmetry arguments: planar",
    "Lesson 3.4 Gauss’s law application: infinite line of charge",
    "Lesson 3.4 Gauss’s law application: infinite plane of charge",
    "Lesson 3.4 Gauss’s law application: conducting sphere",
    "Lesson 3.5 conductors in electrostatic equilibrium",
    "Lesson 3.6 charge distribution on conductors",
   ],
  },
  {
   title: "Electric Potential",
   summary:
    "Lesson 4.1 Electric potential energy (U); Lesson 4.2 Electric potential (V = U/q); Lesson 4.3 Potential due to point charges (V = kq/r); Lesson 4.4 Superposition of potential (scalar addition); Lesson 4.5 Relationship between E and V (E = −∇V, 1D interpretation E = −dV/dx); Lesson 4.6 Equipotential surfaces and interpretation; Lesson 4.7 Potential from continuous charge distributions (integral form).",
   hooks: [
    "Lesson 4.1 electric potential energy U",
    "Lesson 4.2 electric potential V = U/q",
    "Lesson 4.3 potential due to point charge V = kq/r",
    "Lesson 4.4 superposition of potential (scalar)",
    "Lesson 4.5 E = −∇V relationship",
    "Lesson 4.5 1D relationship E = −dV/dx",
    "Lesson 4.6 equipotential surfaces interpretation",
    "Lesson 4.7 potential from continuous charge distributions (integral)",
   ],
  },
  {
   title: "Conductors and Capacitors",
   summary:
    "Lesson 5.1 Electrostatic equilibrium in conductors; Lesson 5.2 Capacitance definition (C = Q/V); Lesson 5.3 Parallel plate capacitor (C = ε₀A/d); Lesson 5.4 Dielectrics and polarization effects; Lesson 5.5 Energy stored in capacitors (U = ½CV²); Lesson 5.6 Capacitors in series and parallel; Lesson 5.7 Charging and discharging concepts (time dependence intro if covered).",
   hooks: [
    "Lesson 5.1 electrostatic equilibrium in conductors",
    "Lesson 5.2 capacitance definition C = Q/V",
    "Lesson 5.3 parallel plate capacitor C = ε0 A / d",
    "Lesson 5.4 dielectrics and polarization effects",
    "Lesson 5.5 energy stored U = 1/2 C V^2",
    "Lesson 5.6 capacitors in series",
    "Lesson 5.6 capacitors in parallel",
    "Lesson 5.7 charging and discharging concepts (time dependence intro)",
   ],
  },
  {
   title: "DC Circuits (calculus-level analysis)",
   summary:
    "Lesson 6.1 Current (I = dQ/dt); Lesson 6.2 Drift velocity model (microscopic interpretation); Lesson 6.3 Ohm’s law (V = IR) and resistivity; Lesson 6.4 Resistance of materials (R = ρL/A); Lesson 6.5 Power in circuits (P = IV, I²R, V²/R); Lesson 6.6 Kirchhoff’s rules (junction + loop equations); Lesson 6.7 Multi-loop circuit solving (system of equations); Lesson 6.8 RC circuits (charging/discharging differential equations); Lesson 6.9 Time constant (τ = RC) and exponential behavior.",
   hooks: [
    "Lesson 6.1 current I = dQ/dt",
    "Lesson 6.2 drift velocity model",
    "Lesson 6.3 Ohm’s law V = IR",
    "Lesson 6.3 resistivity",
    "Lesson 6.4 resistance of materials R = ρL/A",
    "Lesson 6.5 power P = IV",
    "Lesson 6.5 power P = I^2 R",
    "Lesson 6.5 power P = V^2 / R",
    "Lesson 6.6 Kirchhoff’s junction rule",
    "Lesson 6.6 Kirchhoff’s loop rule",
    "Lesson 6.7 multi-loop circuit solving (systems)",
    "Lesson 6.8 RC circuits differential equations",
    "Lesson 6.9 time constant τ = RC",
    "Lesson 6.9 exponential charging/discharging behavior",
   ],
  },
  {
   title: "Magnetic Fields",
   summary:
    "Lesson 7.1 Magnetic field definition and direction rules; Lesson 7.2 Force on moving charges (F = qvB sinθ); Lesson 7.3 Circular motion in magnetic fields (radius r = mv/qB); Lesson 7.4 Force on current-carrying wires (F = ILB sinθ); Lesson 7.5 Magnetic field from moving charges and currents; Lesson 7.6 Biot–Savart law (calculus-based field construction); Lesson 7.7 Ampère’s law (∮B·dl = μ₀Ienc); Lesson 7.8 Fields of long wires, loops, and solenoids.",
   hooks: [
    "Lesson 7.1 magnetic field definition",
    "Lesson 7.1 direction rules for B",
    "Lesson 7.2 force on moving charges F = qvB sinθ",
    "Lesson 7.3 circular motion radius r = mv/(qB)",
    "Lesson 7.4 force on current-carrying wire F = ILB sinθ",
    "Lesson 7.5 magnetic field from moving charges",
    "Lesson 7.5 magnetic field from currents",
    "Lesson 7.6 Biot–Savart law (calculus)",
    "Lesson 7.7 Ampère’s law ∮B·dl = μ0 Ienc",
    "Lesson 7.8 field of long wire",
    "Lesson 7.8 field of current loop",
    "Lesson 7.8 field of solenoid",
   ],
  },
  {
   title: "Electromagnetic Induction",
   summary:
    "Lesson 8.1 Magnetic flux (ΦB = B·A cosθ); Lesson 8.2 Faraday’s law (emf = −dΦB/dt); Lesson 8.3 Lenz’s law (direction of induced current); Lesson 8.4 Motional emf (moving conductor in magnetic field); Lesson 8.5 Induced electric fields (non-conservative fields); Lesson 8.6 Inductance basics (L) and energy in inductors (U = ½LI²); Lesson 8.7 RL circuits (growth and decay behavior).",
   hooks: [
    "Lesson 8.1 magnetic flux ΦB = B·A cosθ",
    "Lesson 8.2 Faraday’s law emf = −dΦB/dt",
    "Lesson 8.3 Lenz’s law direction",
    "Lesson 8.4 motional emf",
    "Lesson 8.5 induced electric fields (non-conservative)",
    "Lesson 8.6 inductance L basics",
    "Lesson 8.6 inductor energy U = 1/2 L I^2",
    "Lesson 8.7 RL circuits growth and decay",
   ],
  },
  {
   title: "Maxwell’s Framework (conceptual synthesis)",
   summary:
    "Lesson 9.1 Gauss’s law for electricity (review in field context); Lesson 9.2 Gauss’s law for magnetism (no magnetic monopoles); Lesson 9.3 Faraday’s law as field coupling; Lesson 9.4 Ampère–Maxwell law (displacement current concept); Lesson 9.5 Unification of electricity and magnetism; Lesson 9.6 Electromagnetic wave concept (qualitative connection only).",
   hooks: [
    "Lesson 9.1 Gauss’s law for electricity (review)",
    "Lesson 9.2 Gauss’s law for magnetism (no monopoles)",
    "Lesson 9.3 Faraday’s law as field coupling",
    "Lesson 9.4 Ampère–Maxwell law (displacement current)",
    "Lesson 9.5 unification of electricity and magnetism",
    "Lesson 9.6 electromagnetic wave concept (qualitative)",
   ],
  },
  {
   title: "Experimental Design and Lab Reasoning",
   summary:
    "Lesson 10.1 Designing field experiments (electric and magnetic setups); Lesson 10.2 Graph interpretation (linearizing exponential RC/RL behavior); Lesson 10.3 Uncertainty and error propagation in measurements; Lesson 10.4 Data collection strategies (multi-variable systems); Lesson 10.5 Justifying models using experimental evidence; Lesson 10.6 AP-style lab FRQ reasoning structure.",
   hooks: [
    "Lesson 10.1 designing electric field experiments",
    "Lesson 10.1 designing magnetic field experiments",
    "Lesson 10.2 graph interpretation: linearize RC exponentials",
    "Lesson 10.2 graph interpretation: linearize RL exponentials",
    "Lesson 10.3 uncertainty and error propagation",
    "Lesson 10.4 data collection strategies (multi-variable systems)",
    "Lesson 10.5 justify models using experimental evidence",
    "Lesson 10.6 AP-style lab FRQ reasoning structure",
   ],
  },
 ]),
 chem: unitsDetailed("chem", [
  {
   title: "Atomic Structure and Properties",
   summary:
    "Lesson 1.1 Classification of matter: elements, compounds, mixtures, separation techniques; Lesson 1.2 Atomic theory and subatomic particles: protons, neutrons, electrons; Lesson 1.3 Isotopes and atomic mass calculations; Lesson 1.4 Electron configuration and orbital diagrams (Aufbau, Pauli, Hund’s rule); Lesson 1.5 Periodic trends: atomic radius, ionization energy, electronegativity; Lesson 1.6 Effective nuclear charge and shielding effects; Lesson 1.7 Photoelectron spectroscopy interpretation.",
   hooks: [
    "Lesson 1.1 classification: elements",
    "Lesson 1.1 classification: compounds",
    "Lesson 1.1 classification: mixtures",
    "Lesson 1.1 separation techniques",
    "Lesson 1.2 subatomic particles: protons neutrons electrons",
    "Lesson 1.3 isotopes",
    "Lesson 1.3 atomic mass calculations",
    "Lesson 1.4 electron configuration",
    "Lesson 1.4 orbital diagrams Aufbau Pauli Hund",
    "Lesson 1.5 periodic trends: atomic radius",
    "Lesson 1.5 periodic trends: ionization energy",
    "Lesson 1.5 periodic trends: electronegativity",
    "Lesson 1.6 effective nuclear charge",
    "Lesson 1.6 shielding effects",
    "Lesson 1.7 photoelectron spectroscopy interpretation",
   ],
  },
  {
   title: "Molecular and Ionic Compound Structure and Properties",
   summary:
    "Lesson 2.1 Ionic vs covalent bonding; Lesson 2.2 Lewis structures and formal charge; Lesson 2.3 Resonance structures and delocalization; Lesson 2.4 VSEPR theory and molecular geometry; Lesson 2.5 Molecular polarity; Lesson 2.6 Intermolecular forces: London dispersion, dipole-dipole, hydrogen bonding; Lesson 2.7 Structure–property relationships (boiling point, melting point, conductivity).",
   hooks: [
    "Lesson 2.1 ionic vs covalent bonding",
    "Lesson 2.2 Lewis structures",
    "Lesson 2.2 formal charge",
    "Lesson 2.3 resonance structures",
    "Lesson 2.3 delocalization",
    "Lesson 2.4 VSEPR theory",
    "Lesson 2.4 molecular geometry",
    "Lesson 2.5 molecular polarity",
    "Lesson 2.6 London dispersion",
    "Lesson 2.6 dipole-dipole",
    "Lesson 2.6 hydrogen bonding",
    "Lesson 2.7 structure-property: boiling point",
    "Lesson 2.7 structure-property: melting point",
    "Lesson 2.7 structure-property: conductivity",
   ],
  },
  {
   title: "Intermolecular Forces and Properties",
   summary:
    "Lesson 3.1 Phase changes and energy changes; Lesson 3.2 Heating curves and cooling curves; Lesson 3.3 Phase diagrams and critical points; Lesson 3.4 Solid structures: ionic, metallic, molecular, network covalent; Lesson 3.5 Gas behavior deviations from ideal assumptions.",
   hooks: [
    "Lesson 3.1 phase changes and energy changes",
    "Lesson 3.2 heating curves",
    "Lesson 3.2 cooling curves",
    "Lesson 3.3 phase diagrams",
    "Lesson 3.3 critical points",
    "Lesson 3.4 solid structures: ionic",
    "Lesson 3.4 solid structures: metallic",
    "Lesson 3.4 solid structures: molecular",
    "Lesson 3.4 solid structures: network covalent",
    "Lesson 3.5 gas deviations from ideal behavior",
   ],
  },
  {
   title: "Chemical Reactions",
   summary:
    "Lesson 4.1 Balancing chemical equations; Lesson 4.2 Net ionic equations and spectator ions; Lesson 4.3 Reaction types and classification; Lesson 4.4 Stoichiometry and mole relationships; Lesson 4.5 Limiting reactants and excess calculations; Lesson 4.6 Percent yield and theoretical yield; Lesson 4.7 Solution chemistry and molarity calculations.",
   hooks: [
    "Lesson 4.1 balancing chemical equations",
    "Lesson 4.2 net ionic equations",
    "Lesson 4.2 spectator ions",
    "Lesson 4.3 reaction types and classification",
    "Lesson 4.4 stoichiometry mole relationships",
    "Lesson 4.5 limiting reactants",
    "Lesson 4.5 excess calculations",
    "Lesson 4.6 percent yield",
    "Lesson 4.6 theoretical yield",
    "Lesson 4.7 solution chemistry",
    "Lesson 4.7 molarity calculations",
   ],
  },
  {
   title: "Kinetics",
   summary:
    "Lesson 5.1 Reaction rates and collision theory; Lesson 5.2 Rate laws and reaction order determination; Lesson 5.3 Integrated rate laws (zero, first, second order); Lesson 5.4 Half-life calculations and interpretation; Lesson 5.5 Reaction mechanisms and rate-determining step; Lesson 5.6 Catalysts and activation energy; Lesson 5.7 Energy diagrams and reaction pathways.",
   hooks: [
    "Lesson 5.1 reaction rates",
    "Lesson 5.1 collision theory",
    "Lesson 5.2 rate laws",
    "Lesson 5.2 reaction order determination",
    "Lesson 5.3 integrated rate laws: zero order",
    "Lesson 5.3 integrated rate laws: first order",
    "Lesson 5.3 integrated rate laws: second order",
    "Lesson 5.4 half-life calculations",
    "Lesson 5.4 half-life interpretation",
    "Lesson 5.5 reaction mechanisms",
    "Lesson 5.5 rate-determining step",
    "Lesson 5.6 catalysts",
    "Lesson 5.6 activation energy",
    "Lesson 5.7 energy diagrams",
    "Lesson 5.7 reaction pathways",
   ],
  },
  {
   title: "Thermodynamics",
   summary:
    "Lesson 6.1 Enthalpy and heat transfer; Lesson 6.2 Calorimetry calculations; Lesson 6.3 Hess’s Law; Lesson 6.4 Bond enthalpy calculations; Lesson 6.5 Entropy and disorder; Lesson 6.6 Gibbs free energy and spontaneity; Lesson 6.7 Temperature dependence of spontaneity.",
   hooks: [
    "Lesson 6.1 enthalpy",
    "Lesson 6.1 heat transfer",
    "Lesson 6.2 calorimetry calculations",
    "Lesson 6.3 Hess’s law",
    "Lesson 6.4 bond enthalpy calculations",
    "Lesson 6.5 entropy and disorder",
    "Lesson 6.6 Gibbs free energy",
    "Lesson 6.6 spontaneity",
    "Lesson 6.7 temperature dependence of spontaneity",
   ],
  },
  {
   title: "Equilibrium",
   summary:
    "Lesson 7.1 Dynamic equilibrium concept; Lesson 7.2 Equilibrium constants (Kc, Kp); Lesson 7.3 Reaction quotient and direction prediction; Lesson 7.4 ICE tables and equilibrium calculations; Lesson 7.5 Le Châtelier’s principle; Lesson 7.6 Solubility equilibrium and Ksp; Lesson 7.7 Common ion effect.",
   hooks: [
    "Lesson 7.1 dynamic equilibrium",
    "Lesson 7.2 equilibrium constants Kc",
    "Lesson 7.2 equilibrium constants Kp",
    "Lesson 7.3 reaction quotient",
    "Lesson 7.3 direction prediction Q vs K",
    "Lesson 7.4 ICE tables",
    "Lesson 7.4 equilibrium calculations",
    "Lesson 7.5 Le Châtelier’s principle",
    "Lesson 7.6 solubility equilibrium Ksp",
    "Lesson 7.7 common ion effect",
   ],
  },
  {
   title: "Acids and Bases",
   summary:
    "Lesson 8.1 Acid and base definitions (Arrhenius, Brønsted–Lowry, Lewis); Lesson 8.2 Strong vs weak acids and bases; Lesson 8.3 pH, pOH, and logarithmic calculations; Lesson 8.4 Ka and Kb equilibrium calculations; Lesson 8.5 Buffers and buffer systems; Lesson 8.6 Titrations and equivalence points; Lesson 8.7 Polyprotic acids.",
   hooks: [
    "Lesson 8.1 Arrhenius definition",
    "Lesson 8.1 Brønsted–Lowry definition",
    "Lesson 8.1 Lewis definition",
    "Lesson 8.2 strong vs weak acids",
    "Lesson 8.2 strong vs weak bases",
    "Lesson 8.3 pH calculations",
    "Lesson 8.3 pOH calculations",
    "Lesson 8.3 logarithmic calculations",
    "Lesson 8.4 Ka equilibrium calculations",
    "Lesson 8.4 Kb equilibrium calculations",
    "Lesson 8.5 buffers",
    "Lesson 8.5 buffer systems",
    "Lesson 8.6 titrations",
    "Lesson 8.6 equivalence points",
    "Lesson 8.7 polyprotic acids",
   ],
  },
  {
   title: "Thermodynamics and Equilibrium Applications",
   summary:
    "Lesson 9.1 Entropy changes in systems and surroundings; Lesson 9.2 Relationship between ΔG and equilibrium constant; Lesson 9.3 Temperature effects on equilibrium; Lesson 9.4 Coupled reactions and equilibrium shifts.",
   hooks: [
    "Lesson 9.1 entropy: system",
    "Lesson 9.1 entropy: surroundings",
    "Lesson 9.2 ΔG and equilibrium constant K",
    "Lesson 9.3 temperature effects on equilibrium",
    "Lesson 9.4 coupled reactions",
    "Lesson 9.4 equilibrium shifts",
   ],
  },
  {
   title: "Laboratory and Data Analysis",
   summary:
    "Lesson 10.1 Significant figures and measurement precision; Lesson 10.2 Experimental uncertainty and error analysis; Lesson 10.3 Gravimetric and volumetric analysis techniques; Lesson 10.4 Calorimetry lab design; Lesson 10.5 Spectrophotometry and Beer-Lambert law; Lesson 10.6 Titration curves and endpoint interpretation; Lesson 10.7 Experimental design and AP FRQ reasoning structure.",
   hooks: [
    "Lesson 10.1 significant figures",
    "Lesson 10.1 measurement precision",
    "Lesson 10.2 experimental uncertainty",
    "Lesson 10.2 error analysis",
    "Lesson 10.3 gravimetric analysis",
    "Lesson 10.3 volumetric analysis",
    "Lesson 10.4 calorimetry lab design",
    "Lesson 10.5 spectrophotometry",
    "Lesson 10.5 Beer-Lambert law",
    "Lesson 10.6 titration curves",
    "Lesson 10.6 endpoint interpretation",
    "Lesson 10.7 experimental design",
    "Lesson 10.7 AP FRQ reasoning structure",
   ],
  },
 ]),
 bio: unitsDetailed("bio", [
  {
   title: "Chemistry of Life",
   summary:
    "Lesson 1.1 Water properties: polarity, hydrogen bonding, cohesion, adhesion, surface tension; Lesson 1.2 Carbon chemistry: functional groups and molecular diversity; Lesson 1.3 Biological macromolecules: carbohydrates, lipids, proteins, nucleic acids; Lesson 1.4 Enzyme structure and function: active site specificity and induced fit; Lesson 1.5 Factors affecting enzyme activity: temperature, pH, substrate concentration, inhibitors.",
   hooks: [
    "Lesson 1.1 water polarity",
    "Lesson 1.1 hydrogen bonding",
    "Lesson 1.1 cohesion adhesion surface tension",
    "Lesson 1.2 functional groups",
    "Lesson 1.2 molecular diversity",
    "Lesson 1.3 carbohydrates lipids proteins nucleic acids",
    "Lesson 1.4 enzyme active site specificity",
    "Lesson 1.4 induced fit",
    "Lesson 1.5 enzyme activity temperature pH",
    "Lesson 1.5 substrate concentration inhibitors",
   ],
  },
  {
   title: "Cell Structure and Function",
   summary:
    "Lesson 2.1 Prokaryotic vs eukaryotic cells; Lesson 2.2 Organelles and their functions; Lesson 2.3 Cell membrane structure: fluid mosaic model; Lesson 2.4 Membrane transport: diffusion, osmosis, facilitated diffusion, active transport; Lesson 2.5 Cell size limits and surface area-to-volume ratio.",
   hooks: [
    "Lesson 2.1 prokaryotic vs eukaryotic",
    "Lesson 2.2 organelles and functions",
    "Lesson 2.3 fluid mosaic model",
    "Lesson 2.4 diffusion osmosis facilitated diffusion",
    "Lesson 2.4 active transport",
    "Lesson 2.5 surface area-to-volume ratio",
    "Lesson 2.5 cell size limits",
   ],
  },
  {
   title: "Cellular Energetics",
   summary:
    "Lesson 3.1 ATP structure and energy coupling; Lesson 3.2 Enzyme role in metabolic pathways; Lesson 3.3 Overview of cellular respiration; Lesson 3.4 Glycolysis, Krebs cycle, electron transport chain; Lesson 3.5 Fermentation pathways; Lesson 3.6 Photosynthesis: light-dependent reactions and Calvin cycle; Lesson 3.7 Energy flow in ecosystems linked to cellular processes.",
   hooks: [
    "Lesson 3.1 ATP energy coupling",
    "Lesson 3.2 enzymes in metabolic pathways",
    "Lesson 3.3 cellular respiration overview",
    "Lesson 3.4 glycolysis Krebs ETC",
    "Lesson 3.5 fermentation",
    "Lesson 3.6 light-dependent reactions Calvin cycle",
    "Lesson 3.7 ecosystem energy flow",
   ],
  },
  {
   title: "Cell Communication and Cell Cycle",
   summary:
    "Lesson 4.1 Signal transduction pathways; Lesson 4.2 Ligands, receptors, and cellular responses; Lesson 4.3 Feedback mechanisms: positive and negative; Lesson 4.4 Cell cycle stages: G1, S, G2, M; Lesson 4.5 Mitosis and cytokinesis; Lesson 4.6 Regulation of the cell cycle and cancer.",
   hooks: [
    "Lesson 4.1 signal transduction",
    "Lesson 4.2 ligands receptors responses",
    "Lesson 4.3 positive negative feedback",
    "Lesson 4.4 G1 S G2 M",
    "Lesson 4.5 mitosis cytokinesis",
    "Lesson 4.6 cell cycle regulation cancer",
   ],
  },
  {
   title: "Heredity",
   summary:
    "Lesson 5.1 Meiosis and genetic variation; Lesson 5.2 Mendelian inheritance patterns; Lesson 5.3 Probability in genetics and Punnett squares; Lesson 5.4 Non-Mendelian inheritance: codominance, incomplete dominance, sex-linked traits; Lesson 5.5 Chromosomal inheritance and linkage; Lesson 5.6 Genetic disorders and pedigree analysis.",
   hooks: [
    "Lesson 5.1 meiosis genetic variation",
    "Lesson 5.2 Mendelian inheritance",
    "Lesson 5.3 probability Punnett squares",
    "Lesson 5.4 codominance incomplete dominance",
    "Lesson 5.4 sex-linked traits",
    "Lesson 5.5 chromosomal inheritance linkage",
    "Lesson 5.6 genetic disorders pedigrees",
   ],
  },
  {
   title: "Gene Expression and Regulation",
   summary:
    "Lesson 6.1 DNA structure and replication; Lesson 6.2 Transcription and RNA processing; Lesson 6.3 Translation and protein synthesis; Lesson 6.4 Gene regulation in prokaryotes (operons); Lesson 6.5 Gene regulation in eukaryotes (epigenetics, transcription factors); Lesson 6.6 Mutations and their effects on proteins; Lesson 6.7 Biotechnology: PCR, gel electrophoresis, DNA sequencing.",
   hooks: [
    "Lesson 6.1 DNA replication",
    "Lesson 6.2 transcription RNA processing",
    "Lesson 6.3 translation protein synthesis",
    "Lesson 6.4 operons prokaryotes",
    "Lesson 6.5 epigenetics transcription factors",
    "Lesson 6.6 mutations protein effects",
    "Lesson 6.7 PCR gel electrophoresis sequencing",
   ],
  },
  {
   title: "Evolution",
   summary:
    "Lesson 7.1 Evidence for evolution; Lesson 7.2 Hardy-Weinberg equilibrium; Lesson 7.3 Mechanisms of evolution: natural selection, drift, gene flow, mutation; Lesson 7.4 Speciation and reproductive isolation; Lesson 7.5 Phylogenetic trees and evolutionary relationships; Lesson 7.6 Evolutionary evidence from molecular biology and fossils.",
   hooks: [
    "Lesson 7.1 evidence for evolution",
    "Lesson 7.2 Hardy-Weinberg",
    "Lesson 7.3 natural selection drift gene flow mutation",
    "Lesson 7.4 speciation reproductive isolation",
    "Lesson 7.5 phylogenetic trees",
    "Lesson 7.6 molecular and fossil evidence",
   ],
  },
  {
   title: "Ecology",
   summary:
    "Lesson 8.1 Population growth models; Lesson 8.2 Community interactions: competition, predation, symbiosis; Lesson 8.3 Ecosystem structure and energy flow; Lesson 8.4 Biogeochemical cycles: carbon, nitrogen, phosphorus; Lesson 8.5 Biodiversity and ecosystem stability; Lesson 8.6 Human impacts on ecosystems: pollution, climate change, habitat loss; Lesson 8.7 Conservation biology principles.",
   hooks: [
    "Lesson 8.1 population growth models",
    "Lesson 8.2 competition predation symbiosis",
    "Lesson 8.3 ecosystem energy flow",
    "Lesson 8.4 carbon nitrogen phosphorus cycles",
    "Lesson 8.5 biodiversity stability",
    "Lesson 8.6 pollution climate habitat loss",
    "Lesson 8.7 conservation biology",
   ],
  },
  {
   title: "Laboratory and Data Analysis Skills",
   summary:
    "Lesson 9.1 Experimental design and controls; Lesson 9.2 Data interpretation and graph analysis; Lesson 9.3 Statistical reasoning (chi-square tests and basic inference concepts); Lesson 9.4 Modeling biological systems; Lesson 9.5 AP-style FRQ scientific reasoning and explanation structure.",
   hooks: [
    "Lesson 9.1 experimental design controls",
    "Lesson 9.2 data interpretation graphs",
    "Lesson 9.3 chi-square statistical reasoning",
    "Lesson 9.4 modeling biological systems",
    "Lesson 9.5 AP FRQ scientific reasoning",
   ],
  },
 ]),
 env: U("env", [
