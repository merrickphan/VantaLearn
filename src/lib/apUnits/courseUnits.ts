 ...
 chem: unitsDetailed("chem", [
  {
   ...
   summary:
    "Lesson 1.1 Matter classification: elements, compounds, mixtures; Lesson 1.2 Atomic theory development and subatomic particles; Lesson 1.3 Isotopes, mass number, atomic mass calculations; Lesson 1.4 Electron configuration and orbital notation; Lesson 1.5 Periodic table organization and trends (radius, ionization energy, electronegativity); Lesson 1.6 Effective nuclear charge and shielding effects; Lesson 1.7 Photoelectron spectroscopy (PES) interpretation.",
   hooks: [
    "Lesson 1.1 matter classification: elements",
    "Lesson 1.1 matter classification: compounds",
    "Lesson 1.1 matter classification: mixtures",
    "Lesson 1.2 atomic theory development",
    "Lesson 1.2 subatomic particles",
    "Lesson 1.3 isotopes and mass number",
    "Lesson 1.3 average atomic mass calculations",
    "Lesson 1.4 electron configuration",
    "Lesson 1.4 orbital notation",
    ...
    "Lesson 1.7 PES interpretation",
   ],
  },
  {
   title: "Molecular and Ionic Compound Structure and Properties",
   summary:
    "Lesson 2.1 Types of chemical bonds: ionic, covalent, metallic; Lesson 2.2 Lewis dot structures and formal charge; Lesson 2.3 Resonance structures and delocalization; Lesson 2.4 VSEPR theory and molecular geometry; Lesson 2.5 Polarity: bond polarity vs molecular polarity; Lesson 2.6 Intermolecular forces: London dispersion, dipole-dipole, hydrogen bonding; Lesson 2.7 Structure-property relationships (melting point, boiling point, conductivity).",
   hooks: [
    "Lesson 2.1 ionic bonding",
    "Lesson 2.1 covalent bonding",
    "Lesson 2.1 metallic bonding",
    "Lesson 2.2 Lewis dot structures",
    ...
    "Lesson 2.5 bond polarity",
    "Lesson 2.5 molecular polarity",
    "Lesson 2.6 London dispersion forces",
    "Lesson 2.6 dipole-dipole forces",
  ...
  },
  {
   ...
   summary:
    "Lesson 3.1 IMFs and phase changes; Lesson 3.2 Heating curves and phase diagrams; Lesson 3.3 Properties of solids: ionic, molecular, metallic, network covalent; Lesson 3.4 Gas properties vs liquids/solids; Lesson 3.5 Deviations from ideal behavior (qualitative Van der Waals ideas).",
   hooks: [
    "Lesson 3.1 IMFs and phase changes",
    "Lesson 3.2 heating curves",
    "Lesson 3.2 phase diagrams",
    "Lesson 3.3 solids: ionic",
    "Lesson 3.3 solids: molecular",
    "Lesson 3.3 solids: metallic",
    "Lesson 3.3 solids: network covalent",
    "Lesson 3.4 gas properties vs liquids and solids",
    "Lesson 3.5 deviations from ideal behavior (Van der Waals qualitative)",
   ],
  },
  {
   title: "Chemical Reactions",
   summary:
    "Lesson 4.1 Writing and balancing equations; Lesson 4.2 Net ionic equations and spectator ions; Lesson 4.3 Reaction types: synthesis, decomposition, combustion, single/double replacement; Lesson 4.4 Stoichiometry: mole ratios and limiting reactants; Lesson 4.5 Percent yield and theoretical yield; Lesson 4.6 Solution stoichiometry and molarity.",
   hooks: [
    "Lesson 4.1 writing equations",
    "Lesson 4.1 balancing equations",
    "Lesson 4.2 net ionic equations",
    "Lesson 4.2 spectator ions",
    "Lesson 4.3 reaction types: synthesis",
    "Lesson 4.3 reaction types: decomposition",
    "Lesson 4.3 reaction types: combustion",
    "Lesson 4.3 reaction types: single replacement",
    "Lesson 4.3 reaction types: double replacement",
    "Lesson 4.4 stoichiometry mole ratios",
    "Lesson 4.4 limiting reactants",
    "Lesson 4.5 theoretical yield",
    "Lesson 4.5 percent yield",
    "Lesson 4.6 molarity",
    "Lesson 4.6 solution stoichiometry",
   ],
  },
  {
   title: "Kinetics",
   summary:
    "Lesson 5.1 Reaction rates and collision theory; Lesson 5.2 Rate laws and reaction order; Lesson 5.3 Integrated rate laws (zero, first, second order); Lesson 5.4 Half-life relationships; Lesson 5.5 Mechanisms and rate-determining steps; Lesson 5.6 Catalysts and activation energy diagrams; Lesson 5.7 Energy profiles and transition states.",
   hooks: [
    "Lesson 5.1 reaction rates",
    "Lesson 5.1 collision theory",
    "Lesson 5.2 rate laws",
    "Lesson 5.2 reaction order",
    ...
    "Lesson 5.4 half-life relationships",
    "Lesson 5.5 reaction mechanisms",
    "Lesson 5.5 rate-determining step",
    "Lesson 5.6 catalysts",
    "Lesson 5.6 activation energy diagrams",
    "Lesson 5.7 energy profiles",
    "Lesson 5.7 transition states",
   ],
  },
  {
   title: "Thermodynamics",
   summary:
    "Lesson 6.1 Endothermic vs exothermic reactions; Lesson 6.2 Enthalpy (ΔH) and calorimetry calculations; Lesson 6.3 Hess’s Law; Lesson 6.4 Bond enthalpies and estimation of ΔH; Lesson 6.5 Entropy (ΔS) and disorder concepts; Lesson 6.6 Gibbs free energy (ΔG = ΔH − TΔS); Lesson 6.7 Spontaneity and temperature dependence.",
   hooks: [
    "Lesson 6.1 endothermic vs exothermic",
    "Lesson 6.2 enthalpy ΔH",
    "Lesson 6.2 calorimetry calculations",
    "Lesson 6.3 Hess’s law",
    "Lesson 6.4 bond enthalpies",
    "Lesson 6.4 estimate ΔH from bond enthalpies",
    "Lesson 6.5 entropy ΔS and disorder",
    "Lesson 6.6 Gibbs free energy ΔG = ΔH − TΔS",
    "Lesson 6.7 spontaneity",
  ...
  },
  {
   title: "Equilibrium",
   summary:
    "Lesson 7.1 Dynamic equilibrium concept; Lesson 7.2 Equilibrium constants (Kc, Kp); Lesson 7.3 Reaction quotient (Q) and equilibrium direction; Lesson 7.4 ICE tables (Initial, Change, Equilibrium); Lesson 7.5 Le Châtelier’s principle; Lesson 7.6 Solubility equilibrium (Ksp); Lesson 7.7 Common ion effect.",
   hooks: [
    "Lesson 7.1 dynamic equilibrium",
    "Lesson 7.2 equilibrium constants Kc",
    "Lesson 7.2 equilibrium constants Kp",
    "Lesson 7.3 reaction quotient Q",
    "Lesson 7.3 equilibrium direction from Q vs K",
  ...
  },
  {
   ...
   summary:
    "Lesson 8.1 Arrhenius, Brønsted–Lowry, Lewis definitions; Lesson 8.2 Strong vs weak acids and bases; Lesson 8.3 pH, pOH, and logarithmic scale; Lesson 8.4 Acid-base equilibrium calculations (Ka, Kb); Lesson 8.5 Buffer systems and Henderson–Hasselbalch equation; Lesson 8.6 Titrations and equivalence points; Lesson 8.7 Polyprotic acids.",
   hooks: [
    "Lesson 8.1 Arrhenius acids and bases",
    "Lesson 8.1 Brønsted–Lowry acids and bases",
    "Lesson 8.1 Lewis acids and bases",
    "Lesson 8.2 strong vs weak acids",
    "Lesson 8.2 strong vs weak bases",
    "Lesson 8.3 pH logarithmic scale",
    "Lesson 8.3 pOH logarithmic scale",
    "Lesson 8.4 Ka calculations",
    "Lesson 8.4 Kb calculations",
    "Lesson 8.5 buffers",
    "Lesson 8.5 Henderson–Hasselbalch equation",
    "Lesson 8.6 titrations",
    "Lesson 8.6 equivalence point",
    "Lesson 8.7 polyprotic acids",
   ],
  },
  {
   title: "Applications of Thermodynamics and Equilibrium",
   summary:
    "Lesson 9.1 Entropy changes in reactions and systems; Lesson 9.2 Free energy and equilibrium relationship (ΔG° = −RT ln K); Lesson 9.3 Temperature effects on equilibrium; Lesson 9.4 Coupled equilibria systems.",
   hooks: [
    "Lesson 9.1 entropy changes in reactions and systems",
    "Lesson 9.2 ΔG° = −RT ln K relationship",
    "Lesson 9.3 temperature effects on equilibrium",
    "Lesson 9.4 coupled equilibria systems",
   ],
  },
  {
   title: "Lab and Experimental Design",
   summary:
    "Lesson 10.1 Measurement and significant figures; Lesson 10.2 Experimental error and uncertainty; Lesson 10.3 Gravimetric and volumetric analysis; Lesson 10.4 Spectrophotometry basics (Beer-Lambert law); Lesson 10.5 Calorimetry experiments; Lesson 10.6 Titration curve interpretation; Lesson 10.7 Designing AP-style lab investigations and FRQ reasoning.",
   hooks: [
    "Lesson 10.1 measurement and significant figures",
    "Lesson 10.2 experimental error and uncertainty",
    "Lesson 10.3 gravimetric analysis",
    "Lesson 10.3 volumetric analysis",
    "Lesson 10.4 spectrophotometry and Beer-Lambert law",
    "Lesson 10.5 calorimetry experiments",
    "Lesson 10.6 titration curve interpretation",
    "Lesson 10.7 AP-style lab investigations and FRQ reasoning",
   ],
  },
 ]),
 bio: U("bio", [
