...
const USH_U1: UshQuestionGen[] = [
 ...
 rows: [
 ["Horses", "Old World (next) Americas"],
 ["Potatoes", "Americas (next) Old World"],
 ["Rice", "Old World (next) Americas"],
 ["Wheat", "Old World (next) Americas"],
 ],
 },
 ),
 ushItem(
 ...
 ushItem(
 "u1-taino",
 "On first landfall in the Caribbean, Columbus encountered peoples such as the Taino; Spanish claims rested on",
