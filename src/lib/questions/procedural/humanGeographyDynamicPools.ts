...
const WRONG_AG = [
  ...
  "Von Thünen’s model ignores distance to market",
] as const;
...
export const HG_U5_DYNAMIC: GeoQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    const [w1, w2, w3] = wrong3(rng, WRONG_AG, correct);
    return geoMc(rng, ctx, i, `hg5-vt-${i}`, `In Von Thünen-style thinking, placing ${ring} closer to or farther from town illustrates that`, correct, w1, w2, w3, "Bid-rent logic structures rural land use in the model.");
  },
  (rng, ctx, i) => {
