/**
 * Parametric AP World History: Modern items — stems and distractors vary by RNG
...
export const WH_U1_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u1dyn-rel-${i}`,
      `Which claim best fits how AP World expects students to treat traditions such as ${faith} c. 1200 regarding society and politics?`,
      correct,
      w1,
      w2,
      w3,
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u1dyn-city-${i}`,
      `In Unit 1, cities such as ${place} are commonly used as examples of`,
      correct,
      w1,
      w2,
      w3,
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u1dyn-emp-${i}`,
      `Which generalization best describes ${emp} in the Unit 1 timeframe?`,
      correct,
      w1,
      w2,
      w3,
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u1dyn-am-${i}`,
      `Developments such as ${americas} in Unit 1 are often contrasted with Afro-Eurasia by noting`,
      correct,
      w1,
      w2,
      w3,
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u1dyn-date-${i}`,
      `Why does the course narrative treat ${p} CE as a meaningful reference point for comparison?`,
      correct,
      w1,
      w2,
      w3,
...
export const WH_U2_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u2dyn-mali-${i}`,
      "Mali and Songhai narratives in Unit 2 emphasize",
      correct,
      w1,
      w2,
      w3,
...
export const WH_U3_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u3dyn-eu-${i}`,
      "European interstate rivalry in Unit 3 is driven by",
      correct,
      w1,
      w2,
      w3,
...
export const WH_U4_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u4dyn-merc-${i}`,
      "Mercantilist empires in Unit 4 relied on",
      correct,
      w1,
      w2,
      w3,
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u4dyn-cash-${i}`,
      "Cash-crop economies in Unit 4 demonstrate",
      correct,
      w1,
      w2,
      w3,
...
export const WH_U5_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u5dyn-wom-${i}`,
      "Women’s rights movements in Unit 5 emphasized",
      correct,
      w1,
      w2,
      w3,
...
export const WH_U9_DYNAMIC: WhQuestionGen[] = [
  ...
  (rng, ctx, i) => {
    ...
    return whMc(
      ...
      i,
      `u9dyn-net-${i}`,
      "Digital technology in Unit 9 matters because it enables",
      correct,
      w1,
      w2,
      w3,
