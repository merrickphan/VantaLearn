      ...
      questions: [
        {
          ...
          figure: {
            kind: "table",
            title: "Table 1. Enzyme activity (μmol/min)",
            headers: ["Temperature (°C)", "Activity"],
            rows: [
              ["20", "12"],
              ["30", "28"],
              ["37", "45"],
          ...
          options: ["20°C", "30°C", "37°C", "45°C"],
          correct_answer: "37°C",
          explanation: "The highest activity (45 μmol/min) occurs at 37°C — typical mammalian enzyme optimum.",
        },
        {
          id: "bio-d2",
          subject: "AP Biology",
      ...
      questions: [
        {
          ...
          explanation: "Slope Δx/Δt = (6−2)/(3−1) = 4/2 = 2 m/s for the linear segment.",
        },
      ],
    },
  },
