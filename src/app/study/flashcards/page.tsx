...
function FlashcardGame({ cards, title }: { cards: FlashcardItem[]; title: string }) {
 ...
 <div>
 <Link href="/study" className="text-xs text-vanta-muted hover:text-vanta-blue transition-colors">Back: Library</Link>
 ...
 <span className="text-xs text-vanta-success">{stats.gotItCount} OK</span>
 <span className="text-xs text-vanta-error">{stats.needsReviewCount} X</span>
